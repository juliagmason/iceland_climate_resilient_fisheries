...
dir.create("../Models/PresAbs_dropSeason")
dir.create("../Models/Biomass_dropSeason")
...
for (spp in spp_25$Spp_ID) {
  ...
  save (gam_PA, file = paste0("../Models/PresAbs_dropSeason/", sci_name, "_PA_full.Rdata"))
  save (gam_LB, file = paste0("../Models/Biomass_dropSeason/", sci_name, "_LB_full.Rdata"))
...
save (maj_spp_gam_summary, file = "../Models/Major_spp_summary_table_dropSeason.RData")
```
